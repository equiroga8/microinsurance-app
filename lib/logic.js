...
async function acceptDelayInsurancePolicy(tx) {
    ...
    delayInsurancePolicy.flightDetails.flightStatus = flightRecord.flightStatus;
...
function getFlightRecordGroupId( flightDetails ){
    ...
    let date = flightDetails.departureDate.toString().slice(0, 10).replace(/-/g, "");
